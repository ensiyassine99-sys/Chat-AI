...
const LoginPage = () => {
  ...
  const handleTwitterLogin = () => {
    const currentLang = i18n.language;
    const twitterAuthUrl = `${import.meta.env.VITE_API_URL}/auth/twitter?lng=${currentLang}`;
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="remember-me" className={`${isRTL ? 'mr-2' : 'ml-2'} block text-sm text-slate-700 dark:text-slate-300 cursor-pointer`}>
                {t('auth.rememberMe')}
              </label>
            </div>
            ...
            <Link
              to="/forgot-password"
              className="text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors outline-none focus:outline-none focus:underline hover:underline underline-offset-2"
            >
